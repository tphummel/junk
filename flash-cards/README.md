...
- `Cards/Us-universities/fbs-nicknames.txt` – FBS college football programs and their mascot nicknames. Each row clozes both the school and the nickname, so cards drill in both directions (school → nickname and nickname → school).
